			...
			<div class="col-sm-12 col-md-4 m-auto">
				<div class="border p-5 mb-5">
					<form method="post">
						...
						<a href="login.php" style="background:#000; color:white;fab fa-github-circl btn btn-block btn-dark text-white margin-top: 200px; text-align: center; font-size: 30px;">Sign in with GitHub</a>    
						</div>
